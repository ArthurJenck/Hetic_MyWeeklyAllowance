    ...
    <main class="container">
        <section class="hero">
            ...
            <div class="hero-cta">
                ...
                <a href="/auth/login-parent" class="btn btn-outline">Se connecter</a>
            </div>
        </section>
        ...
        <section class="cta-section">
            ...
            <p style="font-size: 1.125rem; margin: 1rem 0;">Rejoignez My Weekly Allowance aujourd'hui et enseignez la gestion financière à vos adolescents.</p>
